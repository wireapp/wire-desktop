...
yarn oazapfts --argumentStyle=object --optimistic --useUnknown --futureStripLegacyMethods https://staging-backoffice.ops.zinfra.io/swagger.json e2e-tests/backend/generated/sternApi.ts
```
