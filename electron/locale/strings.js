...
string.wrapperAddAccountErrorMessagePlural =
  'You can only be logged in with {{maximumAccounts}} accounts at once. Log out from one to add another.';
string.wrapperAddAccountErrorMessageSingular =
  'You can only be logged in with one account at once. Log out from this one to add another.';
