...
const TeamIcon = ({ account, onClick }) =>
  <div className="TeamIcon" onClick={onClick} data-uie-id={account.id}>
    <svg style={account.visible ? {} : { display: 'none' }} width="38" height="38" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
