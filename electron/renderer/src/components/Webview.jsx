  ...
  useEffect(() => {
    ...
    return () => {
      if (webview) {
        ...
        .conversation-list-cell-center, .conversation-list-cell-right {
        ...
        .conversations-footer-btn svg {
          height: 36px !important;
        }
        
        .conversations-footer-list {
        ...
        body .controls-right-button {
          border: 0 !important;
        }
        
        .controls-right-button:not(.controls-right-button--send) {
