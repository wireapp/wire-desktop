...
import {
  ...
  WebAppEvents,
  createSandboxLogger,
  SandboxEnvironmentUtil,
  createSandboxLocale,
  truncate,
} from '../shared/contextIsolationConstants';

// WebAppEvents imported from shared constants

// createSandboxLogger imported from shared constants

// SandboxEnvironmentUtil imported from shared constants

// createSandboxLocale imported from shared constants

// truncate imported from shared constants
