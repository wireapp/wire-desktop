...
string.menuVideoCall = 'Videokõne';
string.menuPeople = 'Inimesed';
string.menuAddPeople = 'Lisa inimesi...';
string.menuArchive = 'Arhiveeri';
string.menuUnarchive = 'Arhiivist tagasi';
string.menuMute = 'Vaigista';
string.menuUnmute = 'Lõpeta vaigistus';
string.menuLeave = 'Lahku';
string.menuDelete = 'Kustuta';
string.menuBlock = 'Blokeeri';
string.menuUndo = 'Võta tagasi';
string.menuRedo = 'Tee uuesti';
string.menuCut = 'Lõika';
...
string.menuPreviousConversation = 'Eelmine vestlus';
string.menuFullScreen = 'Täisekraan';
string.menuLegal = 'Juriidiline info';
...
string.unreadMessages = 'Lugemata sõnum';
