...
module.exports = function(grunt) {
  ...
  baseData.connectivityCheckEndpoint = baseData.connectivityCheckEndpoint;
  ...
  baseData.enableSecureUpdater = baseData.enableSecureUpdater;
  ...
  baseData.trustStore = baseData.trustStore;
  ...
  grunt.initConfig({
    ...
    'update-keys': {
      options: {
        config: 'electron/dist/settings/config.js',
      },
    },
  });
