...
export type i18nLanguageIdentifier =
  ...
  | 'aboutVersion'
  | 'aboutWebappVersion'
  | 'certificatePinningRetry'
  | 'certificatePinningShowCertificate'
  | 'certificatePinningShowCertificateMessage'
  | 'certificatePinningWarning'
  | 'certificatePinningWarningBypass'
  | 'certificatePinningWarningTitle'
  | 'menuAbout'
  | 'menuAddPeople'
  | 'menuArchive'
  | 'menuBlock'
