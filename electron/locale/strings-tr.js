...
string.menuMute = 'Sustur';
string.menuUnmute = 'Susturmayı Aç';
...
string.menuPreviousConversation = 'Önceki Konuşma';
string.menuFullScreen = 'Tam Ekran';
string.menuLegal = 'Yasal';
string.menuPrivacy = 'Gizlilik';
string.menuLicense = 'Lisans Bildirgesi';
string.menuSupport = 'Destek İnternet Sitesi';
string.menuWireURL = 'Wire İnternet Sitesi';
string.menuPreferences = 'Seçenekler';
string.menuServices = 'Servisler';
string.menuHideWire = 'Wire’ı Gizle';
