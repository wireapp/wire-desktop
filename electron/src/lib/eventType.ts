...
export const EVENT_TYPE = {
  ...
  IPC: {
    CONFIG: 'EVENT_TYPE.IPC.CONFIG',
    CONTEXT_INNER_TEXT: 'EVENT_TYPE.IPC.CONTEXT_INNER_TEXT',
    CONTEXT_INNER_TEXT_RESPONSE: 'EVENT_TYPE.IPC.CONTEXT_INNER_TEXT_RESPONSE',
    ENVIRONMENTUTIL: 'EVENT_TYPE.IPC.ENVIRONMENTUTIL',
    LOCALE: 'EVENT_TYPE.IPC.LOCALE',
    LOG: 'EVENT_TYPE.IPC.LOG',
    SHOULD_USE_DARK_COLORS: 'EVENT_TYPE.IPC.SHOULD_USE_DARK_COLORS',
    SHOW_DIALOG: 'EVENT_TYPE.IPC.SHOW_DIALOG',
    SSO_DATA: 'EVEN_TYPE.IPC.SSO_DATA',
  },
  LIFECYCLE: {
  ...
  SSO: {
    WINDOW_LOADED: 'EVENT_TYPE.SSO.WINDOW_LOADED',
  },
  UI: {
    BADGE_COUNT: 'EVENT_TYPE.UI.BADGE_COUNT',
    NATIVE_THEME_UPDATED: 'EVENT_TYPE.UI.NATIVE_THEME_UPDATED',
